...
public record SyncBothSigilsPayload(SigilType primarySigil, SigilType secondarySigil) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SyncBothSigilsPayload> CODEC = PacketCodec.tuple(
        ...
        SyncBothSigilsPayload::primarySigil,
        PacketCodecs.STRING.xmap(SigilType::valueOf, SigilType::name),
        SyncBothSigilsPayload::secondarySigil,
